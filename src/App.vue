...
let mostrarParticipante = ref(true);
	...
	<div id="all">
		...
		<div id="participante" v-if="mostrarParticipante == true">
			...
			<div id="contenedor">
				<section>
					<p class="icono">👤</p>
					<p class="texto">NOMBRE <span>ewrwer</span></p>
				</section>
				<section>
					<p class="icono">📱</p>
					<p class="texto">TELEFONO <span>werweqrwe</span></p>
				</section>
				<section>
					<p class="icono">🏠</p>
					<p class="texto">DIRECCIÓN <span>wrewerwer</span></p>
				</section>
				<section>
					<p class="icono">🗓</p>
					<p class="texto">FECHA <span>rwerwerw</span></p>
				</section>
				<section id="final">
					<p class="icono">💾</p>
					<p class="texto">ESTADO <span>werwerw</span></p>
				</section>
			</div>
		</div>
	</div>
